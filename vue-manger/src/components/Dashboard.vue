    ...
    <el-card shadow="hover">
      <vue-event-calendar :events="todoList" @day-changed="handleDayChanged" @month-changed="handleMonthChanged"
        ...
        <template scope="props">
          <div v-for="(event, index) in props.showEvents" :key="index" class="event-item">
            ...
            <div class="wrapper">
              ...
              <el-button type="text" icon="el-icon-edit" circle
                         @click="dialogVisible=true,Event=event"></el-button>
              <el-dialog title="编辑待办事项" :visible.sync="dialogVisible">
                <el-form :model="Event">
          ...
          <el-button type="text" @click="dialogFormVisible = true" icon="el-icon-circle-plus"></el-button>
          <el-dialog title="添加待办事项" :visible.sync="dialogFormVisible" custom-class="insert">
            <el-form :model="Event">
              <el-form-item label="日期" label-width="120px">
                <el-date-picker type="date" placeholder="选择日期" v-model="Event.date"
