      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-row>
              <el-button type="success" icon="el-icon-top" size="small" @click="addManger(scope.row.userName)">升级
              </el-button>
            </el-row>
            <el-button type="danger" size="small" icon="el-icon-bottom" @click="deleteManger(scope.row.userName)">降级
            </el-button>
