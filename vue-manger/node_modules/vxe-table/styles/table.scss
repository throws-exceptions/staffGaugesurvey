...
.vxe-table--filter-wrapper {
  ...
  .vxe-default-select,
  .vxe-input {
    height: $vxe-table-cell-input-height-default;
  }
  .vxe-default-input {
...
.vxe-table {
  ...
  &.border--inner {
    ...
    .vxe-header--column {
      &.col--title-checked {
        background-image: linear-gradient($vxe-table-header-column-checked-border-color, $vxe-table-header-column-checked-border-color);
      }
    }
    .vxe-body--column {
      &.col--seq-checked {
        background-image: linear-gradient($vxe-table-body-seq-column-checked-border-color, $vxe-table-body-seq-column-checked-border-color);
      }
    }
    .vxe-body--column {
      &.col--checked {
        background-image: linear-gradient($vxe-table-body-column-checked-border-color, $vxe-table-body-column-checked-border-color);
      }
    }
  }
  &.border--full {
    ...
    .vxe-header--column {
      &.col--title-checked {
        background-image: linear-gradient($vxe-table-header-column-checked-border-color, $vxe-table-header-column-checked-border-color), linear-gradient($vxe-table-header-column-checked-border-color, $vxe-table-header-column-checked-border-color);
      }
    }
    .vxe-body--column {
      &.col--seq-checked {
        background-image: linear-gradient($vxe-table-body-seq-column-checked-border-color, $vxe-table-body-seq-column-checked-border-color), linear-gradient($vxe-table-body-seq-column-checked-border-color, $vxe-table-body-seq-column-checked-border-color);
      }
    }
    .vxe-body--column {
      &.col--checked {
        background-image: linear-gradient($vxe-table-body-column-checked-border-color, $vxe-table-body-column-checked-border-color), linear-gradient($vxe-table-body-column-checked-border-color, $vxe-table-body-column-checked-border-color);
      }
    }
    .vxe-table--fixed-left-wrapper {
  ...
  &.size--medium {
    ...
    .vxe-cell {
      ...
      .vxe-default-select,
      .vxe-input {
        height: $vxe-table-cell-input-height-medium;
      }
      .vxe-default-input {
        &[type="date"]::-webkit-inner-spin-button {
          margin-top: 4px;
  ...
  &.size--small {
    ...
    .vxe-cell {
      ...
      .vxe-default-select,
      .vxe-input {
        height: $vxe-table-cell-input-height-small;
      }
      .vxe-default-input {
        &[type="date"]::-webkit-inner-spin-button {
          margin-top: 2px;
  ...
  &.size--mini {
    ...
    .vxe-cell {
      ...
      .vxe-default-select,
      .vxe-input {
        height: $vxe-table-cell-input-height-mini;
      }
      .vxe-default-input {
        &[type="date"]::-webkit-inner-spin-button {
          margin-top: 0;
